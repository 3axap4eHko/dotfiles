...
-- Copy lines
map("v", "<C-A-j>", "y'>pgv", { desc = "Copy selected lines down" })
map("v", "<C-A-k>", "y'<Pgv", { desc = "Copy selected lines up" })
map("n", "<C-A-j>", "yyp", { desc = "Copy current line down" })
map("n", "<C-A-k>", "yyP", { desc = "Copy current line up" })
-- Copy paths
