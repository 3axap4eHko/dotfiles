...
map("n", "<space>coa", ":<C-u>CocList diagnostics<cr>", opts)
-- Manage extensions
map("n", "<space>coe", ":<C-u>CocList extensions<cr>", opts)
-- Show commands
map("n", "<space>coc", ":<C-u>CocList commands<cr>", opts)
-- Find symbol of current document
map("n", "<space>coo", ":<C-u>CocList outline<cr>", opts)
-- Search workspace symbols
map("n", "<space>cos", ":<C-u>CocList -I symbols<cr>", opts)
-- Do default action for next item
map("n", "<space>coj", ":<C-u>CocNext<cr>", opts)
-- Do default action for previous item
map("n", "<space>cok", ":<C-u>CocPrev<cr>", opts)
-- Resume latest coc list
map("n", "<space>cop", ":<C-u>CocListResume<cr>", opts)
